...
[TestClass]
public class SubscriberIdDataTypeHandler : TypeHandlerFixtureBase<SubscriberId, SubscriberIdHandler>
{
    [TestMethod]
    ...
    public void Given_Value_When_SetValue_Then_ParameterIsSetup(string value)
    {
        ...
        VerifySetValue(new SubscriberId(guid), DbType.Guid, guid);
    }
    ...
    {
        var guid = Guid.Parse(value);
        Assert.AreEqual(guid, _handler.Parse(guid).Value);
    }
}