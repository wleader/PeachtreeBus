...
[TestClass]
public class CleanSubscribedPendingTrackerFixture
    : IntervalRunTrackerFixtureBase<CleanSubscribedPendingTracker>
{
    protected override CleanSubscribedPendingTracker CreateTracker()
    {
