...
[TestClass]
public class CleanSubscribedCompletedTrackerFixture
    : IntervalRunTrackerFixtureBase<CleanSubscribedCompletedTracker>
{
    protected override CleanSubscribedCompletedTracker CreateTracker()
    {
