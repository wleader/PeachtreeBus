...
{
    [TestClass]
    public class MsSqlManagementGetFailedSubscribedeMessagesFixture : MsSqlManagementDataAccessFixtureBase
    {
        [TestMethod]
        public async Task GetsTheExpectedData()
        {
            ...
            var actual = await BusDataAccess.GetFailedSubscribedMessages(1, 2);
