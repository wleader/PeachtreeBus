...
namespace PeachtreeBus.DatabaseSharing.Tests
{
    ...
    public class SharedDatabaseFixture
    {
        ...
        private SqlConnectionFake _lastConnection = default!;
        private bool _transactionConsumed = false;
        ...
        public void Given_AConnectionIsMade_When_Reconnect_Then_ConnectionIsClosed_And_ConnectionIsDisposed_And_ANewConnectionIsMade()
        {
            ...
            _db.Reconnect();
            Assert.AreEqual(ConnectionState.Closed, originalConnection.State);
