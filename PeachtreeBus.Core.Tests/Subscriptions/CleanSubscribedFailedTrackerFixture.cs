...
[TestClass]
public class CleanSubscribedFailedTrackerFixture
    : IntervalRunTrackerFixtureBase<CleanSubscribedFailedTracker>
{
    protected override CleanSubscribedFailedTracker CreateTracker()
    {
