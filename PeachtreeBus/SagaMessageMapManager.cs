...
namespace PeachtreeBus
{
    ...
    /// </summary>
    class SagaMessageMapManager
    {

        private static readonly Dictionary<Type, SagaMessageMap> Maps = new Dictionary<Type, SagaMessageMap>();
        ...
        /// <returns></returns>
        public static string GetKey(object saga, object message)
        {
