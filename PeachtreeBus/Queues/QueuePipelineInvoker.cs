...
{
    public interface IQueuePipelineInvoker
    {
        Task Invoke(InternalQueueContext context);
    }
        ...
        ISharedDatabase sharedDatabase)
    {
        ...
        public async Task Invoke(InternalQueueContext context)
        {
            ...
            try
            {
                ...
                var pipelineFactory = scope.GetInstance<IQueuePipelineFactory>();
